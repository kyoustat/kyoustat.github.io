...
\moveleft.5\hoffset\centerline{\href{mailto:kisungyou@outlook.com}{kisungyou@outlook.com}}
...
%	\item[]{($*$ $\to$ Corresponding author)}
	\item BS. Thomas, \textbf{K. You}, L. Lin, L-H. Lim, and S. Mukherjee. Learning Subspaces of Different Dimensions. \textit{Journal of Computational and Graphical Statistics}. Accepted.
...
\begin{enumerate}[label={[\roman*]}] 
	\item \textbf{K. You}.  \href{https://arxiv.org/abs/2106.06375}{Parameter Estimation and Model-Based Clustering with Spherical Normal Distribution on the Unit Hypersphere.} \textit{arXiv:2106.06375}.
	\item B. Yu and \textbf{K. You}$^\dagger$. \href{https://arxiv.org/abs/2106.02096}{Shape-Preserving Dimensionality Reduction : An Algorithm and Measures of Topological Equivalence}. Submitted to \textit{Journal of Applied and Computational Topology}. 
